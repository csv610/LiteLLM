...
class PromptBuilder:
    ...
    def get_initial_prompt(topic: str, num_faqs: int = 5) -> str:
        ...
        OUTPUT FORMAT: Provide your response as a single JSON object with the following structure:
        {{
          "topic": "{topic}",
          "core_pillars": ["pillar1", "pillar2", "pillar3"],
          "discovery_faqs": [
    ...
    def get_verification_prompt(topic: str, analysis: str, evidence: List[str]) -> str:
        ...
        {{
          "is_verified": boolean,
          "flaws_identified": ["string", ...] or null,
