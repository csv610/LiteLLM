...
class AgnoDeepDeliberationAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="DeepDeliberation Specialist",
            role="Expert in DeepDeliberation tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for DeepDeliberation."],
        )

        self.verifier = Agent(
            name="DeepDeliberation Verifier",
        ...
        self.manager = Agent(
            name="DeepDeliberation Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the DeepDeliberation workflow.",
