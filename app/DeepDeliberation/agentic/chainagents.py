...
class ChainDeepDeliberationAgents:
    """LangChain-based multi-agent implementation for DeepDeliberation."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for DeepDeliberation.
        
        SPECIALIST ROLE: Expert in DeepDeliberation tasks.
