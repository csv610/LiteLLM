...
from MillenniumPrize.nonagentic.millennium_prize_models import MillenniumProblem, MillenniumProblemsResponse
from MillenniumPrize.nonagentic.millennium_prize_prompts import PromptBuilder
from MillenniumPrize.nonagentic import millennium_prize_problems_cli
...
class TestMillenniumPrize(unittest.TestCase):
    ...
    @patch('MillenniumPrize.nonagentic.millennium_prize_problems_cli.LiteClient')
    @patch('MillenniumPrize.nonagentic.millennium_prize_problems_cli.ModelConfig')
    @patch('MillenniumPrize.nonagentic.millennium_prize_problems_cli.setup_logging')
