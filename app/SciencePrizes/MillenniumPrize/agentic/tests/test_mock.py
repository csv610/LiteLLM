...
from MillenniumPrize.agentic.millennium_prize_models import MillenniumProblem, MillenniumProblemsResponse
from MillenniumPrize.agentic.millennium_prize_prompts import PromptBuilder
from MillenniumPrize.agentic import millennium_prize_problems_cli
...
class TestMillenniumPrize(unittest.TestCase):
    ...
    @patch('MillenniumPrize.agentic.millennium_prize_agents.LiteClient')
    @patch('MillenniumPrize.agentic.millennium_prize_agents.ModelConfig')
