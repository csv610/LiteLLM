...
class ChainMillenniumPrizeAgents:
    """LangChain-based multi-agent implementation for MillenniumPrize."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for MillenniumPrize.
        
        SPECIALIST ROLE: Expert in MillenniumPrize tasks.
