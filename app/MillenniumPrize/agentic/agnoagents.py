...
class AgnoMillenniumPrizeAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="MillenniumPrize Specialist",
            role="Expert in MillenniumPrize tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for MillenniumPrize."],
        )

        self.verifier = Agent(
            name="MillenniumPrize Verifier",
        ...
        self.manager = Agent(
            name="MillenniumPrize Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the MillenniumPrize workflow.",
