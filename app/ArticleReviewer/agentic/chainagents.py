...
class ChainArticleReviewerAgents:
    """LangChain-based multi-agent implementation for ArticleReviewer."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for ArticleReviewer.
        
        SPECIALIST ROLE: Expert in ArticleReviewer tasks.
