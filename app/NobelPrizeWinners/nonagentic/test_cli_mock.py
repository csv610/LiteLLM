...
import NobelPrizeWinners.agentic.nobel_prize_cli as nobel_prize_cli
from NobelPrizeWinners.agentic.nobel_prize_cli import validate_year, validate_category
