...
class ChainNobelPrizeWinnersAgents:
    """LangChain-based multi-agent implementation for NobelPrizeWinners."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for NobelPrizeWinners.
        
        SPECIALIST ROLE: Expert in NobelPrizeWinners tasks.
