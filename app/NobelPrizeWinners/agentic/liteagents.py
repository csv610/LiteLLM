"""
liteagents.py - Unified LiteClient-based agents for NobelPrizeWinners.
"""

from app.NobelPrizeWinners.shared.models import *
...
from app.NobelPrizeWinners.shared.utils import *
