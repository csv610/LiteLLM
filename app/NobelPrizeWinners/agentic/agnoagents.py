...
class AgnoNobelPrizeWinnersAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="NobelPrizeWinners Specialist",
            role="Expert in NobelPrizeWinners tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for NobelPrizeWinners."],
        )

        self.verifier = Agent(
            name="NobelPrizeWinners Verifier",
        ...
        self.manager = Agent(
            name="NobelPrizeWinners Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the NobelPrizeWinners workflow.",
