...
class AgnoQuadrailsAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="Quadrails Specialist",
            role="Expert in Quadrails tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for Quadrails."],
        )

        self.verifier = Agent(
            name="Quadrails Verifier",
        ...
        self.manager = Agent(
            name="Quadrails Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the Quadrails workflow.",
