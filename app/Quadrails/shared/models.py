...
class GuardrailResponse(BaseModel):
    ...
    is_safe: bool = Field(
        description="Overall safety assessment (true if no categories are flagged)"
    )
    flagged_categories: List[GuardrailResult] = Field(
        description="List of flagged safety categories"
    )
