...
def save_result(data: Any, output_filename: Optional[str] = None, input_filename: Optional[str] = None, output_dir: str = "outputs") -> str:
...
def print_result(data: Any) -> None:
    ...
    if hasattr(data, 'markdown') and data.markdown:
        ...
        print(json.dumps(data.model_dump() if hasattr(data, 'model_dump') else data, indent=2))
    print(f"\n{'='*80}\n")
