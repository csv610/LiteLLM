...
class AgnoMathEquationStoryAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="MathEquationStory Specialist",
            role="Expert in MathEquationStory tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for MathEquationStory."],
        )

        self.verifier = Agent(
            name="MathEquationStory Verifier",
        ...
        self.manager = Agent(
            name="MathEquationStory Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the MathEquationStory workflow.",
