...
class ChainMathEquationStoryAgents:
    """LangChain-based multi-agent implementation for MathEquationStory."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for MathEquationStory.
        
        SPECIALIST ROLE: Expert in MathEquationStory tasks.
