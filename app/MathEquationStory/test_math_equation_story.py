...
from math_equation_story_cli import display_story, generate_equation_story
...
class TestMathEquationStoryGenerator(unittest.TestCase):
    @patch('math_equation_story_generator.LiteClient')
...
class TestCLI(unittest.TestCase):
    ...
    @patch('math_equation_story_cli.MathEquationStoryGenerator')
