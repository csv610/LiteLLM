...
class AgnoStudyGuideAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="StudyGuide Specialist",
            role="Expert in StudyGuide tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for StudyGuide."],
        )

        self.verifier = Agent(
            name="StudyGuide Verifier",
        ...
        self.manager = Agent(
            name="StudyGuide Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the StudyGuide workflow.",
