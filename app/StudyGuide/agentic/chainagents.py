...
class ChainStudyGuideAgents:
    """LangChain-based multi-agent implementation for StudyGuide."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for StudyGuide.
        
        SPECIALIST ROLE: Expert in StudyGuide tasks.
