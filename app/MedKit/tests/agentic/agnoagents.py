"""
agnoagents.py - Multi-agent implementation using Agno framework for tests.
"""
...
class AgnoTestsAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            ...
            role="Expert in tests tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for tests."],
