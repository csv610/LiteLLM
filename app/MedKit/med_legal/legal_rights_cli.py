...
def get_user_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="MedKit Legal - Patient Legal Rights Information Generator.")
    ...
    # 1. Generate
    gen_p = subparsers.add_parser("generate", help="Generate legal rights information for a topic")
    gen_p.add_argument("topic", help="Legal right topic (e.g., 'Informed Consent') or file path containing topics.")
    gen_p.add_argument("-c", "--country", default="India", help="The country/jurisdiction for the legal rights (e.g., 'USA', 'UK', 'India').")
