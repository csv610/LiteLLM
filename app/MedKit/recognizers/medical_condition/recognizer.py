...
from .models import MedicalConditionIdentifierModel, ModelOutput
from .prompts import PromptBuilder, MedicalConditionIdentifierInput

class MedicalConditionIdentifier:
    def __init__(self, model_config: ModelConfig):
        self.client = LiteClient(model_config)

    def identify_condition(self, name: str, structured: bool = True) -> ModelOutput:
