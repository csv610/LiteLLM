...
from .models import DiseaseIdentifierModel, ModelOutput
from .prompts import PromptBuilder, DiseaseIdentifierInput

class DiseaseIdentifier:
    def __init__(self, model_config: ModelConfig):
        self.client = LiteClient(model_config)

    def identify_disease(self, name: str, structured: bool = True) -> ModelOutput:
