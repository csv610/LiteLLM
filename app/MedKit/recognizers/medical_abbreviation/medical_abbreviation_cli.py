#!/usr/bin/env python3
"""
CLI for MedicalAbbreviationIdentifier

Identify whether a given name is a recognized medical abbreviation in medical literature
"""
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="medical_abbreviation_identifier",
        description="Identify whether a given name is a recognized medical abbreviation in medical literature",
