...
from app.MedKit.recognizers.medical_anatomy.medical_anatomy_identifier_models import (
    MedicalAnatomyIdentificationModel,
    MedicalAnatomyIdentifierModel,
    ModelOutput,
)
from app.MedKit.recognizers.medical_anatomy.medical_anatomy_identifier_prompts import (
