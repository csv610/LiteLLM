...
from app.MedKit.recognizers.medical_specialty.medical_specialty_identifier import (
    MedicalSpecialtyIdentifier,
)
from app.MedKit.recognizers.medical_specialty.medical_specialty_models import (
    MedicalSpecialtyIdentificationModel,
    MedicalSpecialtyIdentifierModel,
    ModelOutput,
)
from app.MedKit.recognizers.medical_specialty.medical_specialty_prompts import (
