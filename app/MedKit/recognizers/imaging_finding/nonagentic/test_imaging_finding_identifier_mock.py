...
from app.MedKit.recognizers.imaging_finding.nonagentic.imaging_finding_recognizer import (
    ImagingFindingIdentifier,
)
from app.MedKit.recognizers.imaging_finding.nonagentic.imaging_finding_models import (
    ImagingFindingIdentificationModel,
    ImagingFindingIdentifierModel,
    ModelOutput,
)
from app.MedKit.recognizers.imaging_finding.nonagentic.imaging_finding_prompts import (
    ImagingFindingInput,
    PromptBuilder,
)
...
def test_models():
    ...
    identification = ImagingFindingIdentificationModel(
        ...
        is_well_known=True,
        modalities=["CT", "X-ray"],
        differential_diagnosis=["pneumonia", "pulmonary edema"],
    )
    print("✓ IdentificationModel instantiated successfully")

    identifier_model = ImagingFindingIdentifierModel(
        identification=identification,
        summary="Consolidation is a recognized imaging finding in radiology",
        data_available=True,
    )
