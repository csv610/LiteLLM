...
from app.MedKit.recognizers.med_anatomy.nonagentic.med_anatomy_identifier import (
    MedicalAnatomyIdentifier,
)
from app.MedKit.recognizers.med_anatomy.nonagentic.med_anatomy_identifier_models import (
    MedicalAnatomyIdentificationModel,
    MedicalAnatomyIdentifierModel,
    ModelOutput,
)
from app.MedKit.recognizers.med_anatomy.nonagentic.med_anatomy_identifier_prompts import (
...
def test_models():
    ...
    identification = MedicalAnatomyIdentificationModel(
        ...
        clinical_significance="Central organ for blood circulation",
    )
    print("✓ IdentificationModel instantiated successfully")

    identifier_model = MedicalAnatomyIdentifierModel(
        identification=identification,
        summary="Heart is a recognized anatomical structure in medicine",
        data_available=True,
    )
