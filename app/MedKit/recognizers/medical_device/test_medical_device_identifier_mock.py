...
from app.MedKit.recognizers.medical_device.medical_device_identifier import (
    MedicalDeviceIdentifier,
)
from app.MedKit.recognizers.medical_device.medical_device_models import (
    MedicalDeviceIdentificationModel,
    MedicalDeviceIdentifierModel,
    ModelOutput,
)
from app.MedKit.recognizers.medical_device.medical_device_prompts import (
...
def test_models():
    ...
    identifier_model = MedicalDeviceIdentifierModel(
        ...
        summary="Pacemaker is a recognized medical device in medical literature",
        data_available=True,
    )
