...
from .models import PathogenIdentifierModel, ModelOutput
from .prompts import PromptBuilder, PathogenIdentifierInput

class MedicalPathogenIdentifier:
    def __init__(self, model_config: ModelConfig):
        self.client = LiteClient(model_config)

    def identify_pathogen(self, name: str, structured: bool = True) -> ModelOutput:
