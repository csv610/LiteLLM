#!/usr/bin/env python3
"""
CLI for MedicalProcedureIdentifier

Identify whether a given name is a recognized medical procedure in medical literature
"""
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="medical_procedure_identifier",
        description="Identify whether a given name is a recognized medical procedure in medical literature",
...
Examples:
  ...
  %(prog)s "example_medical_procedure" --temperature 0.1
    ...
    parser.add_argument(
        "name",
        help=f"Name of the medical procedure to identify"
    )
