...
from app.MedKit.recognizers.med_coding.nonagentic.med_coding_recognizer import (
    MedicalCodingIdentifier,
)
from app.MedKit.recognizers.med_coding.nonagentic.med_coding_models import (
    MedicalCodingIdentificationModel,
    MedicalCodingIdentifierModel,
    ModelOutput,
)
from app.MedKit.recognizers.med_coding.nonagentic.med_coding_prompts import (
    MedicalCodingInput,
    PromptBuilder,
)
...
def test_models():
    ...
    identifier_model = MedicalCodingIdentifierModel(
        ...
        summary="ICD-10 is a recognized medical coding system",
        data_available=True,
    )
