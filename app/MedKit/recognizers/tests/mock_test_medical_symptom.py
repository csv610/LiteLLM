...
from recognizers.medical_symptom.medical_symptom_identifier import (
    MedicalSymptomIdentifier,
)
from recognizers.medical_symptom.medical_symptom_models import (
...
def test_identify(symptom_identifier):
    ...
    mock_model = MedicalSymptomIdentifierModel(
        identification=mock_data, summary="Symptom info", data_available=True
    )
