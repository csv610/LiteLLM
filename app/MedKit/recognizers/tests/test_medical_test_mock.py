...
from recognizers.medical_test.medical_test_models import (
...
def test_identify(test_identifier):
    ...
    mock_model = MedicalTestIdentifierModel(
        identification=mock_data, summary="Test info", data_available=True
    )
