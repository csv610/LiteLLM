...
from recognizers.medical_vaccine.medical_vaccine_identifier import (
    MedicalVaccineIdentifier,
)
from recognizers.medical_vaccine.medical_vaccine_models import (
    ModelOutput,
...
def test_identify(vaccine_identifier):
    ...
    mock_model = VaccineIdentifierModel(
        identification=mock_data, summary="Vaccine info", data_available=True
    )
