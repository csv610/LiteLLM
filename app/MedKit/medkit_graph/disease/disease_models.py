...
class DiseaseTripletExtractor:
    ...
    def extract_by_name(self, disease_name: str) -> List[Triple]:
        ...
        if self.client is not None:
            model_input = ModelInput(
                user_prompt=prompts.DISEASE_NAME_PROMPT.format(
            ...
            triples.extend(
                [
                    ...
                    },
                    {
                        "source": "Malaria",
                        "relation": "caused_by",
                        "target": "Infected female Anopheles mosquitoes",
                        "source_type": "Disease",
                        "target_type": "Cause",
                    },
                    {
                        "source": "Malaria",
                        "relation": "treated_with",
                        "target": "Artemisinin-based combination therapy",
                        "source_type": "Disease",
