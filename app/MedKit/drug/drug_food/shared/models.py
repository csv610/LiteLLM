...
class TriageResultModel(BaseModel):
    """Initial check for clinical significance."""

    interaction_exists: bool = Field(
        description="Whether a clinically significant interaction is likely to exist"
    )
...
class ComplianceInfoModel(BaseModel):
    ...
    compliance_notes: Optional[str] = Field(
        default=None,
        description="Notes from the compliance officer on clinical accuracy and safety adherence",
    )


class AuditLogModel(BaseModel):
    """Audit log for traceability of agent contributions."""

    pharmacology_raw: Optional[DrugFoodInteractionDetailsModel] = None
    risk_raw: Optional[DrugFoodInteractionDetailsModel] = None
    management_raw: Optional[DrugFoodInteractionDetailsModel] = None
    patient_raw: Optional[PatientFriendlySummaryModel] = None
    search_raw: Optional[DrugFoodInteractionDetailsModel] = None
...
class DrugFoodInteractionModel(BaseModel):
    ...
    compliance_info: Optional[ComplianceInfoModel] = Field(
        default=None,
        description="Medical compliance and safety review information",
    )
    audit_log: Optional[AuditLogModel] = Field(
        default=None,
