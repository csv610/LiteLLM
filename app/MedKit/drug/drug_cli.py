...
def main():
    ...
    interact_p = subparsers.add_parser("interact", help="Drug-drug interaction analysis")
    ...
    disease_p = subparsers.add_parser("disease", help="Drug-disease interaction analysis")
    disease_p.add_argument("medicine", help="Medicine name")
    disease_p.add_argument("disease", help="Disease name")

    # 5. Similar Drugs
    similar_p = subparsers.add_parser("similar", help="Find similar or alternative medicines")
    ...
    # 7. Symptoms to Drugs
    symptoms_p = subparsers.add_parser("symptoms", help="Suggest drugs for symptoms (for reference)")
    symptoms_p.add_argument("symptoms", help="Symptom description")

    # 8. Drug Addiction
    addiction_p = subparsers.add_parser("addiction", help="Drug addiction and recovery info")
    ...
    # Logging config
    configure_logging(log_file="medkit_drug.log", verbosity=args.verbosity, enable_console=True)
