...
class AuditLogModel(BaseModel):
    ...
    pharmacology_raw: Optional[DrugInteractionDetailsModel] = None
    risk_raw: Optional[DrugInteractionDetailsModel] = None
    management_raw: Optional[DrugInteractionDetailsModel] = None
    patient_raw: Optional[PatientFriendlySummaryModel] = None
    search_raw: Optional[DrugInteractionDetailsModel] = None
