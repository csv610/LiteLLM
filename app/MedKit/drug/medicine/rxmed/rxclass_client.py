"""rxclass_client - RxNorm and RxClass API client for drug classification and relationships.
...
class RxClassClient:
    ...
    def get_class_by_drug_name(self, drug_name: str, rela_source: Optional[str] = None) -> Dict[str, Any]:
        ...
        if rela_source:
            params["relaSource"] = rela_source
        return self._get("/class/byDrugName.json", params=params)
    ...
    def get_class_tree(self, class_id: str, rela_source: Optional[str] = None) -> Dict[str, Any]:
        ...
        if rela_source:
            params["relaSource"] = rela_source
        return self._get("/classTree.json", params=params)
