...
class Medication(BaseModel):
    ...
    frequency: str = Field(description="Frequency of administration (e.g., BID, TID, Once daily)")
...
class PrescriptionData(BaseModel):
    ...
    prescriber: str = Field(description="Name of the prescribing doctor or healthcare professional")
...
class PrescriptionExtractor:
    ...
    def extract(self, image_path: str) -> PrescriptionData:
        ...
        try:
            ...
            raise ValueError("Failed to extract structured prescription data from the image.")
