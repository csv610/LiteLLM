"""
chainagents.py - Multi-agent implementation using LangChain for symptoms_drugs.
"""
...
class ChainSymptomsDrugsAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.llm = get_chain_model(model_name)
        self.prompt = PromptTemplate.from_template("""
        You are a multi-agent system for symptoms_drugs.
        SPECIALIST ROLE: Expert in symptoms_drugs tasks.
