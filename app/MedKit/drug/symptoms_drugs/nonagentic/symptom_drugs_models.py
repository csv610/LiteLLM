...
class DrugRecommendation(BaseModel):
    ...
    rationale: str = Field(
        description="Why this drug is typically prescribed for the symptom"
    )
    common_dosage: Optional[str] = Field(
        default=None, description="Typical dosage or frequency for this symptom"
    )
...
class SymptomDrugAnalysisModel(BaseModel):
    ...
    description: str = Field(
        description="Brief description of the symptom and its typical clinical context"
    )
