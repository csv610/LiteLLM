...
class MedicalProcedureInfoGenerator:
    ...
    def generate_text(self, procedure: str) -> ProcedureInfo:
        ...
        model_input = ModelInput(
            user_prompt=self._create_prompt(procedure),
            response_format=ProcedureInfo,
            system_prompt="You are an expert medical documentation specialist. Generate comprehensive, evidence-based procedure information."
        )
    ...
    def _create_prompt(self, procedure: str) -> str:
        """Generate the prompt for procedure info."""
