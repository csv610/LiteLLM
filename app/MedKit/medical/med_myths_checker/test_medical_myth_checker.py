...
from medical.med_myths_checker.medical_myth_checker_models import (
    MedicalMythAnalysisModel, ModelOutput, MythAnalysisModel
)

@pytest.fixture
def mock_lite_client():
    with patch('medical.med_myths_checker.medical_myth_checker.LiteClient') as mock:
        yield mock
...
@patch('medical.med_myths_checker.medical_myth_checker.save_model_response')
