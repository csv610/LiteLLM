...
from medical.herbal_info.nonagentic.herbal_info_models import (
...
def mock_lite_client():
    with patch("medical.herbal_info.nonagentic.herbal_info.LiteClient") as mock:
        yield mock
...
@patch("medical.herbal_info.nonagentic.herbal_info.save_model_response")
