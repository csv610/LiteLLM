"""
chainagents.py - Multi-agent implementation using LangChain for surgical_pose_info.
"""
...
class ChainSurgicalPoseInfoAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.llm = get_chain_model(model_name)
        self.prompt = PromptTemplate.from_template("""
        You are a multi-agent system for surgical_pose_info.
        SPECIALIST ROLE: Expert in surgical_pose_info tasks.
