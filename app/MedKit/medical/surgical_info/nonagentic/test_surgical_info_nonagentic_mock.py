...
from medical.surgical_info.nonagentic.surgery_info_models import (
    AlternativesModel,
...
def mock_lite_client():
    with patch("medical.surgical_info.nonagentic.surgical_info.LiteClient") as mock:
        yield mock
...
@patch("medical.surgical_info.nonagentic.surgical_info.save_model_response")
