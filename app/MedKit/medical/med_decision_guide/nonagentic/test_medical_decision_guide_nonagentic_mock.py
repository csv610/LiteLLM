...
from medical.med_decision_guide.nonagentic.medical_decision_guide_models import (
    DecisionNode,
...
def mock_lite_client():
    with patch("medical.med_decision_guide.nonagentic.medical_decision_guide.LiteClient") as mock:
        yield mock
...
@patch("medical.med_decision_guide.nonagentic.medical_decision_guide.save_model_response")
