"""
agnoagents.py - Multi-agent implementation using Agno framework for med_ethics.
"""
...
class AgnoMedEthicsAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.model = get_agno_model(model_name)
        
        self.specialist = Agent(
            name="med_ethics Specialist",
            role="Expert in med_ethics tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for med_ethics."],
        )

        self.verifier = Agent(
            name="med_ethics Verifier",
        ...
        self.manager = Agent(
            name="med_ethics Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the med_ethics workflow.",
