"""
chainagents.py - Multi-agent implementation using LangChain for anatomy.
"""
...
class ChainAnatomyAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.llm = get_chain_model(model_name)
        self.prompt = PromptTemplate.from_template("""
        You are a multi-agent system for anatomy.
        SPECIALIST ROLE: Expert in anatomy tasks.
