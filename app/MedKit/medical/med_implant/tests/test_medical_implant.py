...
from medical.med_implant.medical_implant_models import ModelOutput, MedicalImplantInfoModel
...
def generator(model_config):
    with patch('medical.med_implant.medical_implant.LiteClient') as mock_client:
...
@patch('medical.med_implant.medical_implant.PromptBuilder')
...
def test_save(generator, tmp_path):
    ...
    with patch('medical.med_implant.medical_implant.save_model_response') as mock_save:
