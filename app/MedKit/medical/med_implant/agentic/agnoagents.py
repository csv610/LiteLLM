"""
agnoagents.py - Multi-agent implementation using Agno framework for med_implant.
"""
...
class AgnoMedImplantAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.model = get_agno_model(model_name)
        
        self.specialist = Agent(
            name="med_implant Specialist",
            role="Expert in med_implant tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for med_implant."],
        )

        self.verifier = Agent(
            name="med_implant Verifier",
        ...
        self.manager = Agent(
            name="med_implant Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the med_implant workflow.",
