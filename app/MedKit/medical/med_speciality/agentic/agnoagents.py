"""
agnoagents.py - Multi-agent implementation using Agno framework for med_speciality.
"""
...
from app.MedKit.medical.med_speciality.shared.models import ModelOutput
...
class AgnoMedSpecialityAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.model = get_agno_model(model_name)
        
        self.specialist = Agent(
            name="med_speciality Specialist",
            role="Expert in med_speciality tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for med_speciality."],
        )

        self.verifier = Agent(
            name="med_speciality Verifier",
        ...
        self.manager = Agent(
            name="med_speciality Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the med_speciality workflow.",
