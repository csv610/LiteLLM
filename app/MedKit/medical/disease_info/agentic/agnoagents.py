"""
agnoagents.py - Multi-agent implementation using Agno framework for disease_info.
"""
...
from app.MedKit.medical.disease_info.shared.models import ModelOutput
...
class AgnoDiseaseInfoAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.model = get_agno_model(model_name)
        
        self.specialist = Agent(
            name="disease_info Specialist",
            role="Expert in disease_info tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for disease_info."],
        )

        self.verifier = Agent(
            name="disease_info Verifier",
        ...
        self.manager = Agent(
            name="disease_info Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the disease_info workflow.",
