"""
chainagents.py - Multi-agent implementation using LangChain for med_topic.
"""
...
class ChainMedTopicAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        self.model_name = model_name
        self.llm = get_chain_model(model_name)
        self.prompt = PromptTemplate.from_template("""
        You are a multi-agent system for med_topic.
        SPECIALIST ROLE: Expert in med_topic tasks.
