...
from medical.med_symptom_checker.symptom_detection_qa import MedicalConsultation, EmergencyException

def test_detect_red_flags():
    consultation = MedicalConsultation()
    
    is_emergency, flags = consultation.detect_red_flags("I have severe chest pain and chest pressure")
