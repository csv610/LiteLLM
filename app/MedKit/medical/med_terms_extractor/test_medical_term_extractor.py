...
from medical.med_terms_extractor.medical_term_extractor_models import (
    MedicalTerms, ModelOutput, Disease, Medicine, Symptom
)
...
def test_generate_text_structured(mock_lite_client):
    ...
    result = extractor.generate_text("Patient has diabetes, takes metformin, complains of polyuria", structured=True)
