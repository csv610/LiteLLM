...
def get_user_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("test", type=str, help="Medical test name or path to a file containing test names (one per line).")
...
def create_medical_test_info_report(args) -> int:
    ...
    try:
        ...
        pbar = tqdm(tests, desc="Processing medical tests", unit="test", disable=len(tests) <= 1)
