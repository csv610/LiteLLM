...
def test_generate_text_nonagentic(mock_lite_client):
    ...
    # The Explorer expects an object with a 'problems' attribute
    mock_response = MagicMock()
    mock_response.problems = [sample]
    
    instance = mock_lite_client.return_value
    instance.generate_text.return_value = mock_response
