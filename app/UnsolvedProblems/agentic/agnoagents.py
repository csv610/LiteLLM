...
class AgnoUnsolvedProblemsAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="UnsolvedProblems Specialist",
            role="Expert in UnsolvedProblems tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for UnsolvedProblems."],
        )

        self.verifier = Agent(
            name="UnsolvedProblems Verifier",
        ...
        self.manager = Agent(
            name="UnsolvedProblems Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the UnsolvedProblems workflow.",
