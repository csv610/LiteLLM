...
class ChainUnsolvedProblemsAgents:
    """LangChain-based multi-agent implementation for UnsolvedProblems."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for UnsolvedProblems.
        
        SPECIALIST ROLE: Expert in UnsolvedProblems tasks.
