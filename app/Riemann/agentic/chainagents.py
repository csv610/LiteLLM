...
class ChainRiemannAgents:
    """LangChain-based multi-agent implementation for Riemann."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for Riemann.
        
        SPECIALIST ROLE: Expert in Riemann tasks.
