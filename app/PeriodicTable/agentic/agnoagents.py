...
class AgnoPeriodicTableAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="PeriodicTable Specialist",
            role="Expert in PeriodicTable tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for PeriodicTable."],
        )

        self.verifier = Agent(
            name="PeriodicTable Verifier",
        ...
        self.manager = Agent(
            name="PeriodicTable Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the PeriodicTable workflow.",
