...
@pytest.fixture
def mock_agentic_lite_client():
    # Patch our new client wrapper
    with patch('app.MathTheories.agentic.math_theory_element.AgenticLiteClient') as mock:
        yield mock

def test_explain_theory_agentic(mock_agentic_lite_client):
    instance = mock_agentic_lite_client.return_value
    ...
    # Mock the new method
    instance.generate_json.side_effect = [research, explanation, feedback]
    ...
    # Assert the new method was called
    assert instance.generate_json.call_count == 3
