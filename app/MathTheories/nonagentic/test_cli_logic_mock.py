...
from MathTheories.nonagentic.math_theory_cli import fetch_theory_info
from MathTheories.nonagentic.math_theory_models import MathTheory, AudienceLevel, TheoryExplanation, SolutionMethods
...
class TestCLIFunctionality(unittest.TestCase):
    ...
    @patch('MathTheories.nonagentic.math_theory_cli.MathTheoryExplainer')
