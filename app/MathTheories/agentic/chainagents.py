...
class ChainMathTheoriesAgents:
    """LangChain-based multi-agent implementation for MathTheories."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for MathTheories.
        
        SPECIALIST ROLE: Expert in MathTheories tasks.
