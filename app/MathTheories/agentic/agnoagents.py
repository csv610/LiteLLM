...
class AgnoMathTheoriesAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="MathTheories Specialist",
            role="Expert in MathTheories tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for MathTheories."],
        )

        self.verifier = Agent(
            name="MathTheories Verifier",
        ...
        self.manager = Agent(
            name="MathTheories Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the MathTheories workflow.",
