...
from HilbertProblems.nonagentic.hilbert_problems import HilbertProblemsGuide
from HilbertProblems.nonagentic.hilbert_problems_models import HilbertProblemModel, ProblemStatus

@pytest.fixture
def mock_lite_client():
    with patch('HilbertProblems.nonagentic.hilbert_problems.LiteClient') as mock:
        yield mock
