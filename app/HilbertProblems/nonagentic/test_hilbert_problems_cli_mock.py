...
from HilbertProblems.nonagentic.hilbert_problems_cli import main, argument_parser
...
@patch('HilbertProblems.nonagentic.hilbert_problems_cli.HilbertProblemsGuide')
