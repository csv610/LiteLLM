...
class AgnoHilbertProblemsAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="HilbertProblems Specialist",
            role="Expert in HilbertProblems tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for HilbertProblems."],
        )

        self.verifier = Agent(
            name="HilbertProblems Verifier",
        ...
        self.manager = Agent(
            name="HilbertProblems Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the HilbertProblems workflow.",
