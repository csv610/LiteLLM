...
class ChainHilbertProblemsAgents:
    """LangChain-based multi-agent implementation for HilbertProblems."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for HilbertProblems.
        
        SPECIALIST ROLE: Expert in HilbertProblems tasks.
