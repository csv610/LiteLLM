...
class ChainFAQGeneratorAgents:
    """LangChain-based multi-agent implementation for FAQGenerator."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for FAQGenerator.
        
        SPECIALIST ROLE: Expert in FAQGenerator tasks.
