...
class AgnoFAQGeneratorAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="FAQGenerator Specialist",
            role="Expert in FAQGenerator tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for FAQGenerator."],
        )

        self.verifier = Agent(
            name="FAQGenerator Verifier",
        ...
        self.manager = Agent(
            name="FAQGenerator Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the FAQGenerator workflow.",
