...
class LogicData(BaseModel):
    ...
    the_contradiction: str = Field(..., description="The core contradiction or counter-intuitive nature explained rigorously")
...
class DomainData(BaseModel):
    ...
    logical_resolution: str = Field(..., description="Logical or philosophical details of the resolution")
    mathematical_resolution: str = Field(..., description="Mathematical or scientific details of the resolution")
