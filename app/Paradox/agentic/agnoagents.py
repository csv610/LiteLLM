...
class AgnoParadoxAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="Paradox Specialist",
            role="Expert in Paradox tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for Paradox."],
        )

        self.verifier = Agent(
            name="Paradox Verifier",
        ...
        self.manager = Agent(
            name="Paradox Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the Paradox workflow.",
