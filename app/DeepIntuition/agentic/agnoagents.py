...
class AgnoDeepIntuitionAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="DeepIntuition Specialist",
            role="Expert in DeepIntuition tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for DeepIntuition."],
        )

        self.verifier = Agent(
            name="DeepIntuition Verifier",
        ...
        self.manager = Agent(
            name="DeepIntuition Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the DeepIntuition workflow.",
