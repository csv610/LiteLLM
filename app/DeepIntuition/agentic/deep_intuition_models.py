...
class HistoricalResearch(BaseModel):
    ...
    key_historical_anchors: List[str] = Field(..., description="Specific historical events, people, or failures.")
    archive_of_failures_details: str = Field(..., description="Detailed research notes on failed attempts.")
...
class CounterfactualAnalysis(BaseModel):
    ...
    counterfactual_world: str = Field(..., description="A deep look at a world without this discovery.")
    modern_resonance: str = Field(..., description="Current relevance and applications.")
...
class StruggleNarrative(BaseModel):
    ...
    human_triumph_rationale: str = Field(..., description="Why this was a persistence-based triumph.")
...
class DeepIntuitionStory(BaseModel):
    ...
    the_human_struggle: str = Field(..., description="The story of the systematic exploration and failures.")
    the_aha_moment: str = Field(..., description="The perspective shift explained through an analogy.")
    human_triumph_rationale: str = Field(..., description="Why this was a triumph of persistence.")
