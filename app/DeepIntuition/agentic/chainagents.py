...
class ChainDeepIntuitionAgents:
    """LangChain-based multi-agent implementation for DeepIntuition."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for DeepIntuition.
        
        SPECIALIST ROLE: Expert in DeepIntuition tasks.
