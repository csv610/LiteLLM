...
from GenerateBook.agentic.bookchapters_models import (
    AgentTrace,
    BookChaptersModel,
    BookInput,
    ChapterSuggestion,
...
from GenerateBook.agentic.bookchapters_prompts import PromptBuilder
...
class TestBookChaptersGenerator(unittest.TestCase):
    @patch('GenerateBook.agentic.bookchapters_generator.LiteClient')
