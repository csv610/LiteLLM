...
class AgnoGenerateBookAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="GenerateBook Specialist",
            role="Expert in GenerateBook tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for GenerateBook."],
        )

        self.verifier = Agent(
            name="GenerateBook Verifier",
        ...
        self.manager = Agent(
            name="GenerateBook Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the GenerateBook workflow.",
