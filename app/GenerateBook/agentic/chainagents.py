...
class ChainGenerateBookAgents:
    """LangChain-based multi-agent implementation for GenerateBook."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for GenerateBook.
        
        SPECIALIST ROLE: Expert in GenerateBook tasks.
