...
class AgnoScholarWorkAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="ScholarWork Specialist",
            role="Expert in ScholarWork tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for ScholarWork."],
        )

        self.verifier = Agent(
            name="ScholarWork Verifier",
        ...
        self.manager = Agent(
            name="ScholarWork Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the ScholarWork workflow.",
