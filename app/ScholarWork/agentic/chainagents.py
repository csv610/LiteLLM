...
class ChainScholarWorkAgents:
    """LangChain-based multi-agent implementation for ScholarWork."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for ScholarWork.
        
        SPECIALIST ROLE: Expert in ScholarWork tasks.
