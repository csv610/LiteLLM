...
class AgnoObjectGuesserAgents:
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        self.specialist = Agent(
            name="ObjectGuesser Specialist",
            role="Expert in ObjectGuesser tasks",
            model=self.model,
            instructions=["Provide deep analysis and structured insights for ObjectGuesser."],
        )

        self.verifier = Agent(
            name="ObjectGuesser Verifier",
        ...
        self.manager = Agent(
            name="ObjectGuesser Manager",
            team=[self.specialist, self.verifier],
            model=self.model,
            instructions=[
                "Coordinate the ObjectGuesser workflow.",
