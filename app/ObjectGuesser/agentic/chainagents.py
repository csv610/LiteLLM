...
class ChainObjectGuesserAgents:
    """LangChain-based multi-agent implementation for ObjectGuesser."""
    ...
    def __init__(self, model_name: str = "gemini/gemini-2.5-flash"):
        ...
        You are a multi-agent system for ObjectGuesser.
        
        SPECIALIST ROLE: Expert in ObjectGuesser tasks.
