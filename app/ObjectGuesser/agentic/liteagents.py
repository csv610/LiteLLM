...
from app.ObjectGuesser.shared.models import *
...
class ObjectGuesserGame:
    ...
    def __init__(self, model: str = "ollama/gemma3", temperature: float = 0.7, max_questions: int = 20):
        ...
        """
        self.model_config = ModelConfig(model=model, temperature=0.2)  # Low temperature for extraction/state
    ...
    def update_state(self):
        ...
        user_prompt = self.prompt_builder.build_user_prompt(self.conversation_history, self.blackboard)
    ...
    def decide_strategy(self) -> dict:
        ...
        user_prompt = self.prompt_builder.build_user_prompt([], self.blackboard) # Just needs current state
