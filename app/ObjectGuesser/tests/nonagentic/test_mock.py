...
class TestPromptBuilder(unittest.TestCase):
    ...
    def test_user_prompt(self):
        ...
        self.assertIn("thought of an object", prompt)
...
class TestObjectGuessingGame(unittest.TestCase):
    ...
    def test_add_to_history(self):
        ...
        self.assertEqual(
            self.game.conversation_history[0], {"role": "user", "content": "yes"}
        )
    ...
    def test_extract_guess(self):
        ...
        self.assertEqual(self.game.extract_guess("I guess it's a orange."), "orange")
